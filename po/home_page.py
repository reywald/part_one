...
class HomePage(BasePage):
    ...
    def __init__(self, driver, testclass) -> None:
        ...
        self.heading: WebElement = self.driver.find_element(By.CSS_SELECTOR, "#root .App-header > h1")
        self.login_button: WebElement = self.driver.find_element(By.CSS_SELECTOR, "#root p a")
